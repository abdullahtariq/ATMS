...
$agentResult="SELECT * FROM projects WHERE user_id=$url_id";
// echo $agentResult ;
$projects=mysqli_query($conn,$agentResult);
// print_r($projects);
			...
			<div class="form-group pull-right">
				<div class="row">
					<div class="col-sm-2 col-sm-offset-3">
						<a href="index.php?act=hmupdate&id=<?php echo $ftnresult['user_id'] ; ?>"="bottom" title="Edit">
...
<div class="table-responsive tale-strip-color" id="tabular">
 <table class="table-striped table table-wrap"    >
  ...
  $allday=0;
  $totalCost=0;
  while ($agReport=mysqli_fetch_assoc($projects)) {
